...
{
    public class TV101_AdaptiveController : ApiController
    {
        ...
        private ResResult formatLink(string link)
        {
            ...
            obj1.header = "User-Agent"; obj1.value = "Morize";
            ResParam obj2 = new ResParam();
            obj2.header = "Referer"; obj2.value = "abc";
            objList.Add(obj1);
            objList.Add(obj2);
        ...
        private string getLinkFromTV101(string original)
        {
            ...
            if (firstResult != "")
            {
                ...
                /*
                string[] splitLinks = secondResponse.Split('\n');
                int count = splitLinks.Length;
                string highRes = splitLinks[count - 2];
                string midRes = splitLinks[count - 4];
                string lowRes = splitLinks[count - 6];
