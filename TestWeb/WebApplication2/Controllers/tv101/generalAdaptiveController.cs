...
{
    public class generalAdaptiveController : ApiController
    {
        List<string> links = new List<string>();
        public ResResult Get(string original, string id0 = "", string id1 = "", string id2 = "", string id3 = "", string id4 = "")
        {
            string link = getLinkFromTV101(original);
            return formatLink(link);
        }
        public ResResult Get(){
            string link = getLinkFromTV101("abc");
            return formatLink(link);
        }
        ...
        private string getLinkFromTV101(string original)
        {
            ...
            int pTo = -1;
            int i = 0;
            original = "http://tv.101vn.com/livetv-xem-tivi-kenh-hbo-menu-nuocngoai.html";
            ...
            links.Clear();
            //links.Add("http://api.phimbathu.com/getfb/play.php?q=U2FsdGVkX18tvKqcfhTPVT49Z8tl%2FDkwUT%2FG6RmFHYV%2FTn8bY09eJtnoR2dSd4Vg35mLqH4t0t9IccQVVCaleiS3v%2FJ%2BLSN%2FNyozSB5BaaOzMuOMpoBNKc6bj8YZR2v2");
            links.Add("https://api.phimbathu.com/getfb/play.php?q=U2FsdGVkX195%2F4IElI%2FDn%2FxKmqgfAarVs8PW%2FzsXZztU%2F6zrFUdDCEwjCPdreiWkAfnsRcNkURj6w3HCZfesbR%2BQfgcisyqH66RybRG%2FzDZ3E0D5wSqfcgJbWpPgC1iu");
            String secondResult = "";
            String firstResult = "";
            int index = 0;
