...
{
    public class THVLI2Controller : ApiController
    {
        ...
        private string getLinkTHVLI()
        {
            ...
            try
            {
                string firstRequest = "http://api.thvli.vn/backend/cm/detail/thvl2-hd/";
                ...
                if (exp_resolution.Length > 8)
                {
                    ...
                    string low_res = prefix + "/" + exp_resolution[7];
                    string mid_res = prefix + "/" + exp_resolution[5];
                    string high_res = prefix + "/" + exp_resolution[3];
